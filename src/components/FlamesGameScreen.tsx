      ...
      {gameState === 'idle' && (
        <div className="bg-white border-4 border-black p-8 relative overflow-hidden neo-shadow-lg animate-fade-in">
          ...
          <form onSubmit={handleCalculate} className="space-y-8 relative z-10">
            {/* Full Name Astrological Instruction Box */}
            <div className="bg-amber-50 border-2 border-black p-3.5 flex items-start gap-3" id="fullname-instruction-box">
              <Info className="w-5 h-5 text-black shrink-0 mt-0.5" />
              <div>
                <p className="font-mono text-xs font-black text-black uppercase tracking-wide">
                  ASTROLOGICAL PROTOCOL: ENTER FULL NAMES
                </p>
                <p className="font-mono text-[10px] text-zinc-600 uppercase tracking-tight mt-1 leading-normal">
                  For precise cosmic matching resonance, please enter complete names (first and last names) rather than simple initials or casual short nicknames.
                </p>
              </div>
            </div>
